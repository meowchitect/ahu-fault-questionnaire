...
function displayCurrentFault() {
    ...
    faultContainer.innerHTML = `
        ...
        <p>Please select all symptoms that could be caused by this fault. <b>If you do not find any related symptoms, you may skip this part without making any selections and click the "Next Fault" button directly</b>.</p>
